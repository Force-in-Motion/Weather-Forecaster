...
from src.view.widgets.gray.combobox import SwapCbox
from src.view.widgets.gray.buttons import UpdateButton, ExitButton
from src.view.widgets.gray.frames import MainFrame, WeatherSubscribersFrame
from src.view.widgets.gray.labels import TitleLabel, WeatherSubscriber
