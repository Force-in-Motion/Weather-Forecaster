from src.interface.widget_factory import AWidgetFactory
from src.view.widgets.light.combobox import SwapCbox
from src.view.widgets.light.buttons import UpdateButton, ExitButton
from src.view.widgets.light.frames import MainFrame, WeatherSubscribersFrame
from src.view.widgets.light.labels import TitleLabel, WeatherSubscriber
