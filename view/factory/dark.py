...
from view.widgets.dark.combobox import SwapCbox
from view.widgets.dark.buttons import UpdateButton, ExitButton
from view.widgets.dark.frames import MainFrame, WeatherSubscribersFrame
from view.widgets.dark.labels import TitleLabel, WeatherSubscriber
