...
from view.widgets.gray.combobox import SwapCbox
from view.widgets.gray.buttons import UpdateButton, ExitButton
from view.widgets.gray.frames import MainFrame, WeatherSubscribersFrame
from view.widgets.gray.labels import TitleLabel, WeatherSubscriber
